...
TEST(statement_data_test, change_invoice_number)
{
...
TEST(statement_data_test, change_date)
{
...
TEST(statement_data_test, change_order_number)
{
...
TEST(statement_data_test, change_paid_status)
{
...
TEST(statement_data_test, change_price)
{
...
TEST(statement_data_test, successfully_maintain_data_integrity)
{
...
TEST(statement_data_test, unsuccessfully_maintain_data_integrity)
{
        std::string expected{""};
        data.set_invoice_number(expected);
...
TEST(statement_data_test, ensure_copyable)
{
        std::string invoice_number{"1234"};
        std::string date{"12/04/2025"};
        std::string order_number{"123 mdb"};
...
TEST(statement_data_test, ensure_copy_constructable)
{
        std::string invoice_number{"1234"};
        std::string date{"12/04/2025"};
        std::string order_number{"123 mdb"};
        ...
        data.set_paid_status(paid_status);
        data.set_price(price);
        data::statement result{data};

        CHECK(result.is_valid());
}

TEST(statement_data_test, ensure_moveable)
{
        std::string invoice_number{"1234"};
        std::string date{"12/04/2025"};
        std::string order_number{"123 mdb"};
...
TEST(statement_data_test, ensure_move_constructable)
{
        std::string invoice_number{"1234"};
        std::string date{"12/04/2025"};
        std::string order_number{"123 mdb"};
        ...
        data.set_paid_status(paid_status);
        data.set_price(price);
        data::statement result{std::move(data)};
