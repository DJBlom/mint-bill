...
function help()
{
    ...
    $ECHO "${INFO_COLOR}\t\t\t[DESIGN], installs the Cambalache application used for GUI design\n\r${END_COLOR}"
    $ECHO "${INFO_COLOR}\t\t\t[ANALYSIS], installs the Gaphor application for block diagram analysis\n\r${END_COLOR}"
